...
try{
 ...
 if($_POST) 
		...
		if($sonuc = $conn ->query("DELETE FROM araba WHERE araba_id=$id")==true){
            ...
            <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Araba sil</h1>
                    </div>
...
<th style='text-align:center;'>Marka adı</th>
...
$query = $conn->query("SELECT * FROM araba inner join kategori on (kat_id=katag_id) inner join marka on(marka.marka_id=kitap.markas_id)");
