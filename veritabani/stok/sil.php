...
try{
 ...
 if($_POST) 
		...
		if($sonuc = $conn ->query("DELETE FROM s_bedel WHERE araba_id=$id")==true && $sonuc = $conn ->query("DELETE FROM g_bedel WHERE araba_id=$id")==true && $sonuc = $conn ->query("DELETE FROM y_bedel WHERE araba_id=$id")==true){
            ...
            <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Araba kira sil</h1>
                    </div>
...
<th style='text-align:center;'>Aylık</th>
<th style='text-align:center;'>Yıllık</th>
...
echo "<td style='text-align:center;'>".strval($row[6]) ."</td>";
echo "<td style='text-align:center;'>".$row[9]."</td>";
echo "<td style='text-align:center;'>".$row[12]."</td>";
echo "<form form action='sil.php' method='post'><td style='text-align:center;'> <input type='hidden' name='id'value='".$row['araba_id']."'> <input type='submit'value='Sil' ></form>";
}
